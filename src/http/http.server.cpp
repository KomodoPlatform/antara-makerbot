...
namespace antara::mmbot
{
    ...
    http_server::router http_server::create_routes()
    {
        ...
        http_router->http_get("/api/v1/legacy/mm2/my_orders", [this](auto &&... params) {
            return this->mm2_rest_callbook_.my_orders(std::forward<decltype(params)>(params)...);
        });
        ...
        http_router->http_post("/api/v1/legacy/mm2/send_raw_transaction", [this](auto &&... params) {
            return this->mm2_rest_callbook_.send_raw_transaction(std::forward<decltype(params)>(params)...);
        });

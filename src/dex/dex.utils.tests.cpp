...
namespace antara::mmbot::tests
{
    ...
    TEST_CASE ("mm::order can be converted to orders::order")
    {
        ...
        auto mm_order = mm2::order{uuid, base, rel, base_amount, price_str};
    ...
    TEST_CASE ("can convert a mm2::swap into an execution")
    {
        ...
        auto expected = orders::execution{ id, pair, price, quantity, side, maker};
        ...
        auto event_ts = mm2::event_ts{event, "timestamp"};
